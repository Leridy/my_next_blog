    ...
    <div className="h-[440px] bg-[rgba(223,242,235,0.95)] dark:bg-[rgba(26,54,54,0.95)] text-[rgba(40,44,52,0.9)] dark:text-[rgba(226,226,226,0.9)] p-4 rounded-lg ">
      ...
      >
        {filteredTodos.length === 0 ? (
          <div className="text-center py-4 text-[rgba(102,102,102,0.75)] dark:text-[rgba(204,204,204,0.8)]">
            暂无任务
          </div>
        ) : (
          <div>
              ...
              >
                ...
                <div
                  className={`flex-grow px-3 cursor-pointer ${
                    todo.completed
                      ? 'line-through text-[rgba(102,102,102,0.75)] dark:text-[rgba(204,204,204,0.8)]'
                      : ''
                  }`}
                  onClick={() => toggleComplete(todo.id)}
                >
